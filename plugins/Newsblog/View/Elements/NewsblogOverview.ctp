...
<div class='newsblogcontainer'><?php 
...
<div class="newsblog_entry_subtitle"><?php echo $subtitle?></div>
	<?php }?>
<div class="newsblog_entry_info">by <?php echo $createdBy?> on <?php echo $createdOnDate?>
at <?php echo $createdOnTime;?> <?php 
...
<div class="newsblog_entry_footer"><?php 
echo $this->Html->link(
					'> Weiterlesen',
...
<div class="newsblog_entry_buttons"><?php 
if($editAllowed){
	echo $this->Html->link(
