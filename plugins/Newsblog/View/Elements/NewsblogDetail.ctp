...
<div class='showFullNewsTitle'><?php echo $data['NewsEntry']['title'];?>
</div>
...
<div class='showFullNewsInfo'><?php 
...
?> <?php echo $createdBy;?> on <?php echo $createdOnDate;?> at <?php echo $createdOnTime;

if(isset($modifiedOnDate) & isset($modifiedOnTime)){
	echo "&nbsp;&nbsp;(modified on ".$modifiedOnDate." at ".$modifiedOnTime.")";
}
?></div>
<div class='showFullNewsBody'><?php echo $this->BBCode->transformBBCode($data['NewsEntry']['text']);?>
</div>
<div class='showFullNewsSocial'></div>
<div class='showFullNewsOptions'></div>
</div>
