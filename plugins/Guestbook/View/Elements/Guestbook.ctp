...
<div id='guestbook_write'><?php echo $this->Form->create('GuestbookPost', array('url' => array('plugin' => 'Guestbook', 'controller' => 'GuestbookPost','action' => 'save')));?>
<table>
	<tr>
		<td><?php echo $this->Form->label('author', __('Name'));?></td>
	...
	<tr>
		<td><?php echo $this->Form->label('title', __('Title'));?></td>
	...
	<tr>
		<td><?php echo $this->Form->label('text', __('Text'));?></td>
...
<div class='guestbook_navigation'><?php
...
<div class='guestbook_post_author'><?php echo $GuestbookPost['GuestbookPost']['author'] . __(' on ') . $this->Time->format('d.m.Y', $GuestbookPost['GuestbookPost']['created']) . __(' at ') . $this->Time->format('H:i:s',$GuestbookPost['GuestbookPost']['created'])?>
</div>
<div class='guestbook_post_title'><?php echo $GuestbookPost['GuestbookPost']['title']?>
<?php
...
?></div>
<div class='guestbook_post_text'><?php echo $GuestbookPost['GuestbookPost']['text']?>
</div>
</div>
