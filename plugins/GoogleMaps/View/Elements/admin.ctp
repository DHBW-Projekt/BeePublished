...
<table  id="address_table">
	...
	<?php foreach ($locations as $location): ?>
	    <tr>
		    ...
		    <td>
		    	<?php if ($currentLocation == $location) {echo "<b>"; }?>
		    		<?php echo $location['GoogleMapsLocation']['street']; ?>
		    	<?php if ($currentLocation == $location) {echo "</b>"; }?>
		    </td>
		    <td>
		   		<?php if ($currentLocation == $location) {echo "<b>"; }?>
		    		<?php echo $location['GoogleMapsLocation']['street_number']; ?>
		    	<?php if ($currentLocation == $location) {echo "</b>"; }?>
		    </td>
		    <td>
		   		<?php if ($currentLocation == $location) {echo "<b>"; }?>
		   		 	<?php echo $location['GoogleMapsLocation']['zip_code']; ?>
		    	<?php if ($currentLocation == $location) {echo "</b>"; }?>
		    </td>
		    <td>
		   		<?php if ($currentLocation == $location) {echo "<b>"; }?>
		   		 	<?php echo $location['GoogleMapsLocation']['city']; ?>
		    	<?php if ($currentLocation == $location) {echo "</b>"; }?>
		    </td>
		    <td>
		   		<?php if ($currentLocation == $location) {echo "<b>"; }?>
		   		 	<?php echo $location['GoogleMapsLocation']['country']; ?>
		    	<?php if ($currentLocation == $location) {echo "</b>"; }?>
		    </td>
		    <td>
		    	<?php 
