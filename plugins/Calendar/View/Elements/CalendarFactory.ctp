...
<div class="<?php echo $ClassPrefix; ?>calendar_head"><?php if ($navigation) : ?>
<div class="<?php echo $ClassPrefix; ?>month_minus"><?php echo $this->Html->link('<< ' . date('M y', strtotime('-1 months', $time)), $url . 'largecalendar/month/' . date('Y-m', strtotime('-1 months', $time)));?></div>
<div class="<?php echo $ClassPrefix; ?>month_plus"><?php echo $this->Html->link(date('M y', strtotime('+1 months', $time)) . ' >>', $url . 'largecalendar/month/' . date('Y-m', strtotime('+1 months', $time)));?></div>
<?php endif; ?>
<div class="<?php echo $ClassPrefix; ?>calendar_name"><?php echo $this->Html->link(date('F Y', $time), $url . 'largecalendar/month/' . date('Y-m', $time));?></div>
</div>
<table cellspacing="0">
	<colgroup>
	<?php if ($ShowWeeks): ?>
