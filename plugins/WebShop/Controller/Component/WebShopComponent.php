...
class WebShopComponent extends Component {
	...
	*/
	...
	function submitOrder($controller, $pluginID=null, $contentValues=null, $url=null){
		...
		//SEND mail
		$this->BeeEmail->sendEmail($to = $this->Config->getValue('email'), $subject = 'DualonCMS: New Order', $viewVars = array('order' => $order, 'url' => 'localhost'/*env('SERVER_NAME')*/), $viewName = 'WebShop.order');
