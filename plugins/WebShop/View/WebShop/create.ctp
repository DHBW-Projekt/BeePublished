 ...
 *
 * @description Create new products for the catalog.
 */
...
<?php 
	...
	//TITLE
	echo '<h2>'.__d("web_shop", 'Create Product').'</h2>';
	...
	echo $this->Form->file('WebshopProduct.submittedfile', array('label' => false)); 
	echo "<br>";
