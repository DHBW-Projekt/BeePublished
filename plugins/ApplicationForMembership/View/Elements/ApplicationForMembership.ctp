...
<?php $input = $this->Session->read('Validation.ApplicationForMembership.data');?>
<?php $errors = $this->Session->read('Validation.ApplicationForMembership.validationErrors');?>
...
<div id='application_for_membership_write'>

<?php echo $this->Form->create('ApplicationForMembership', 
					array('url' => array('plugin' => 'ApplicationForMembership', 'controller' => 'ApplicationForMembership', 'action' => 'send')));?>
	<table>
	<tr>
			<td colspan="2">
