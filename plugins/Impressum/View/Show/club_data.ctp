<h2>
	<?php echo __('Bitte geben Sie die Daten Ihres Vereins ein.') ?>
</h2>
<br>
<?php
	...
	if (!empty($input['Impressum']['comp_name'])) {
		echo $this->Form->input('Impressum.comp_name', array('label' => __('Vereinsbezeichnung:'), 'value' => $input['Impressum']['comp_name']));
	} else {
		echo $this->Form->input('Impressum.comp_name', array('label' => __('Vereinsbezeichnung:')));
	}
