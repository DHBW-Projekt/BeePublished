...
<body class="overlay">
<div id="overlay-header"><?php echo $this->Html->image('beelogo_small.png'); ?>
</div>
<div id="content" class="overlay"><?php echo $this->Session->flash(); ?>
<?php echo $content_for_layout ?></div>
<div id="footer">Powered by BeePublished - All rights reserved - &copy;
Copyright 2011-2012</div>
</div>
<?php
