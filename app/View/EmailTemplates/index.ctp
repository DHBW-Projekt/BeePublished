...
<?php
	...
	echo $this->Form->submit(__('Create new template'), array('name' => 'CreateTemplate'));
	echo $this->Form->submit(__('Show template'), array('name' => 'ShowTemplate'));
	echo $this->Form->end();
?>	
</div>
<div>
...
<?php
	...
	echo $this->Form->end(__('Activate Template'));
?>	
</div>