...
<?php if (array_key_exists('columns', $child)): ?>
    ...
    <?php if (!array_key_exists('plugin', $child['content'])): ?>
        ...
        <div class="plugin_content">
            <?php echo $this->element($child['content']['view'], array('data' => $child['content']['viewData'], 'url' => $child['content']['pageUrl'], 'contentId' => $child['content']['id'], 'plugin' => $child['content']['plugin']), array('plugin' => $child['content']['plugin'])); ?>
        </div>
        <?php endif; ?>
    <?php endif; ?>
<?php endforeach; ?>
