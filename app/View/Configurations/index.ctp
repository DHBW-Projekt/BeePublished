...
echo $this->Form->input('active_template', array('options' => $themes, array('label' => __('Template:'))));
echo $this->Form->input('active_design', array('options' => $designs, array('label' => __('Design:'))));
