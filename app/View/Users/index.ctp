...
<div rel="<?php echo $role['Role']['id'];?>" class="users"><?php foreach ($role['User'] as $user): ?>
...
<div><?php echo $this->Html->link($this->Html->image('edit.png', array('width' => '20', 'height' => '20')),array('controller' => 'Users', 'action' => 'edit', $user['id']),array('escape' => false, 'class' => 'user_edit')); ?>
