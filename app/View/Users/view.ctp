...
<dl>
	...
	<dd><?php echo $this->Html->link($user['Role']['name'], array('controller' => 'roles', 'action' => 'view', $user['Role']['id'])); ?>
	&nbsp;</dd>
	...
	<dd><?php echo h($user['User']['last_login']); ?> &nbsp;</dd>
	<dt><?php echo __('Registered'); ?></dt>
	<dd><?php echo h($user['User']['registered']); ?> &nbsp;</dd>
	<dt><?php echo __('Confirmation Token'); ?></dt>
	<dd><?php echo h($user['User']['confirmation_token']); ?> &nbsp;</dd>
...
<ul>
	...
	<li><?php echo $this->Html->link(__('List Roles'), array('controller' => 'roles', 'action' => 'index')); ?>
	</li>
	<li><?php echo $this->Html->link(__('New Role'), array('controller' => 'roles', 'action' => 'add')); ?>
	</li>
	<li><?php echo $this->Html->link(__('List Log Entries'), array('controller' => 'log_entries', 'action' => 'index')); ?>
	</li>
	<li><?php echo $this->Html->link(__('New Log Entry'), array('controller' => 'log_entries', 'action' => 'add')); ?>
	</li>
	<li><?php echo $this->Html->link(__('List Pages'), array('controller' => 'pages', 'action' => 'index')); ?>
	</li>
	<li><?php echo $this->Html->link(__('New Page'), array('controller' => 'pages', 'action' => 'add')); ?>
	</li>
</ul>
</div>
<div class="related">
...
<table cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="actions"><?php echo $this->Html->link(__('View'), array('controller' => 'log_entries', 'action' => 'view', $logEntry['id'])); ?>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="actions"><?php echo $this->Html->link(__('View'), array('controller' => 'pages', 'action' => 'view', $page['id'])); ?>
